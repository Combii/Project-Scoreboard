...
window.onload = function() {
    ...
    ctx1.fillText("0", canvas1.width / 2, canvas1.height / 2);
    ctx2.fillText("0", canvas2.width / 2, canvas2.height / 2);
};
...
function setScore1(){
    ...
    ctx.fillText(score1, canvas.width/2, canvas.height/2);
}
...
function setScore2(){
    ...
    ctx.fillText(score2, canvas.width/2, canvas.height/2);
}
